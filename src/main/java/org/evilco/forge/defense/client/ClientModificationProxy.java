 ...
 */
package org.evilco.forge.defense.client;
...
public class ClientModificationProxy extends CommonModificationProxy {
	 ...
	 */
	protected final void registerBlockEntityRenderers () {
		// call modules
		for (IModule module : this.getActiveModules ()) module.registerRenderers ();
	}
}
