 ...
 */
public interface ISurveillanceNetworkRespondingEntity extends ISurveillanceNetworkEntity {

	/**
	 * Notifies the entity about an alarm.
	 * @param authority The authority issuing the alarm.
