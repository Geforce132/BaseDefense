 ...
 */
package org.evilco.mc.defense.client.renderer.item.sensor;
...
import org.evilco.mc.defense.client.model.sensor.CameraModel;
 ...
 */
public class CameraItemRenderer implements IItemRenderer {

	/**
	 * Stores the camera model.
	 */
	protected static final CameraModel model = new CameraModel ();
	...
	public void renderDroppedItem (ItemStack item, Object[] data) {
		...
		// bind texture
		Minecraft.getMinecraft ().renderEngine.bindTexture (new ResourceLocation ("defense", "textures/blocks/sensor/camera.png"));
	...
	public void renderEquippedItem (ItemRenderType type, ItemStack item, Object[] data) {
		...
		GL11.glTranslatef (0.3f, -1.8f, -0.05f);
	...
	public void renderInventoryItem (ItemStack item, Object[] data) {
		// correct position
		GL11.glTranslatef (-0.2f, 1.9f, 0.0f);
