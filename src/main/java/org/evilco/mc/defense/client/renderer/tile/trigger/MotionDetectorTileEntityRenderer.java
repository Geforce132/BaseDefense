 ...
 */
package org.evilco.mc.defense.client.renderer.tile.trigger;
 ...
 */
public class MotionDetectorTileEntityRenderer extends TileEntitySpecialRenderer {

	/**
	 * Stores the child model.
	 */
	...
	public void renderTileEntityAt (TileEntity var1, double var2, double var4, double var6, float var8) {
		...
		GL11.glPushMatrix ();
		this.bindTexture (new ResourceLocation ("defense", "textures/blocks/trigger/motionDetector" + (((MotionDetectorTileEntity) var1).isConnected () ? "" : "Inactive") + ".png"));
