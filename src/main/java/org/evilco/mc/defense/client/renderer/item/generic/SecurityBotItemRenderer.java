 ...
 */
package org.evilco.mc.defense.client.renderer.item.generic;
 ...
 */
public class SecurityBotItemRenderer implements IItemRenderer {

	/**
	 * Stores the security bot model.
	 */
	protected static final SecurityBotModel model = new SecurityBotModel ();
	...
	public void renderDroppedItem (ItemStack item, Object[] data) {
		...
		// bind texture
		Minecraft.getMinecraft ().renderEngine.bindTexture (new ResourceLocation ("defense", "textures/entities/generic/securityBot.png"));
