 ...
 */
package org.evilco.mc.defense.client.renderer.item.machine;
...
import org.evilco.mc.defense.client.model.machine.DrumModel;
 ...
 */
public class DrumItemRenderer implements IItemRenderer {

	/**
	 * Stores the drum model.
	 */
	protected static final DrumModel model = new DrumModel ();
	...
	public void renderDroppedItem (ItemStack item, Object[] data) {
		...
		// bind texture
		Minecraft.getMinecraft ().renderEngine.bindTexture (new ResourceLocation ("defense", "textures/blocks/machine/rollingMill.png"));
	...
	public void renderEquippedItem (ItemRenderType type, ItemStack item, Object[] data) {
		// move
		GL11.glRotatef (180.0f, 1.0f, 0.0f, 0.0f);
		GL11.glTranslatef (1.0f, -0.9f, 0.15f);
