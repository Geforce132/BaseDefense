 ...
 */
public class DefenseStationItemRenderer implements IItemRenderer {

	/**
	 * Stores the item model.
	 */
	protected static final DefenseStationModel model = new DefenseStationModel ();
	...
	public void renderEquippedItem (ItemRenderType type, ItemStack item, Object[] data) {
		// move
		GL11.glRotatef (180.0f, 1.0f, 0.0f, 0.0f);
		GL11.glTranslatef (1.2f, -0.5f, 0.15f);
